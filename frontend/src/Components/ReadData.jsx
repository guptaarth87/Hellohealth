  ...
  render(){
    ...
    <div className="col-lg-2">
      ...
      <div className="col-lg-3">
        <label for="number_inp" className="form-label inp_wid">Number</label>
      ...
      <button className="col-lg-2 btn inp_wid btn-primary apply" onClick={()=>this.handleFilter()}>Apply Filters</button>
    </div>
